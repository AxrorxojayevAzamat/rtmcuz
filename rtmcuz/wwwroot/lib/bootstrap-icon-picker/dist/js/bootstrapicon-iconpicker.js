...
(function (e) {
    ...
    t.defaultOptions = c.extend(t.defaultOptions, {
        icons: [
            { title: "icon icon-unit", searchTerms: ["unit"] },
            { title: "icon icon-vk", searchTerms: ["vk", "vcontact", "vkontakt"] },
            { title: "icon icon-chat", searchTerms: ["chat"] },
            { title: "icon icon-chevrone-bottom", searchTerms: ["chevrone", "bottom"] },
            { title: "icon icon-chevrone-left", searchTerms: ["chevrone", "left"] },
            { title: "icon icon-chevrone-right", searchTerms: ["chevrone", "right"] },
            { title: "icon icon-chevrone-top", searchTerms: ["chevrone", "top"] },
            { title: "icon icon-close", searchTerms: ["close"] },
            { title: "icon icon-connector", searchTerms: ["connector"] },
            { title: "icon icon-earth", searchTerms: ["earth"] },
            { title: "icon icon-email", searchTerms: ["email"] },
            { title: "icon icon-et", searchTerms: ["et"] },
            { title: "icon icon-eye", searchTerms: ["eye"] },
            { title: "icon icon-fb", searchTerms: ["fb", "facebook"] },
            { title: "icon icon-fttb", searchTerms: ["fttb"] },
            { title: "icon icon-Gear", searchTerms: ["Gear"] },
            { title: "icon icon-glasses", searchTerms: ["glasses"] },
            { title: "icon icon-globus", searchTerms: ["globus"] },
            { title: "icon icon-gsm-icon", searchTerms: ["gsm"] },
            { title: "icon icon-house", searchTerms: ["house"] },
            { title: "icon icon-info", searchTerms: ["info"] },
            { title: "icon icon-layers-icon", searchTerms: ["layers"] },
            { title: "icon icon-logo-uztelecom", searchTerms: ["logo", "uztelecom"] },
            { title: "icon icon-minus-fill", searchTerms: ["minus"] },
            { title: "icon icon-mobile", searchTerms: ["mobile"] },
            { title: "icon icon-mobile-free", searchTerms: ["mobile"] },
            { title: "icon icon-monitor", searchTerms: ["monitor"] },
            { title: "icon icon-monitor-2", searchTerms: ["monitor"] },
            { title: "icon icon-offices", searchTerms: ["offices"] },
            { title: "icon icon-ok", searchTerms: ["ok"] },
            { title: "icon icon-packet", searchTerms: ["packet"] },
            { title: "icon icon-person", searchTerms: ["person"] },
            { title: "icon icon-phone-0", searchTerms: ["phone"] },
            { title: "icon icon-phone-1", searchTerms: ["phone"] },
            { title: "icon icon-phone-2", searchTerms: ["phone"] },
            { title: "icon icon-phone-3", searchTerms: ["phone"] },
            { title: "icon icon-phone-4", searchTerms: ["phone"] },
            { title: "icon icon-phone-call", searchTerms: ["phone"] },
            { title: "icon icon-phone-code", searchTerms: ["phone"] },
            { title: "icon icon-phones", searchTerms: ["phones"] },
            { title: "icon icon-plus-fill", searchTerms: ["plus"] },
            { title: "icon icon-printer", searchTerms: ["printer"] },
            { title: "icon icon-question", searchTerms: ["question"] },
            { title: "icon icon-radar", searchTerms: ["radar"] },
            { title: "icon icon-router", searchTerms: ["router"] },
            { title: "icon icon-rss", searchTerms: ["rss"] },
            { title: "icon icon-search", searchTerms: ["search"] },
            { title: "icon icon-Shape-593x", searchTerms: ["Shape"] },
            { title: "icon icon-signal", searchTerms: ["signal"] },
            { title: "icon icon-sms", searchTerms: ["sms"] },
            { title: "icon icon-sms-2", searchTerms: ["sms"] },
            { title: "icon icon-sms-code", searchTerms: ["sms"] },
            { title: "icon icon-sort", searchTerms: ["sort"] },
            { title: "icon icon-spanner", searchTerms: ["spanner"] },
            { title: "icon icon-tg", searchTerms: ["tg", "telegram"] },
            { title: "icon icon-tw", searchTerms: ["tw", "twitter"] },
            { title: "icon icon-unlimited", searchTerms: ["unlimited"] },
            { title: "icon icon-user", searchTerms: ["user"] },
            { title: "icon icon-wallet", searchTerms: ["wallet"] },
            { title: "icon icon-warning", searchTerms: ["warning"] },
            { title: "icon icon-wave-line", searchTerms: ["wave"] },
            { title: "icon icon-wifi", searchTerms: ["wifi"] },
            { title: "icon icon-www", searchTerms: ["www"] },
            { title: "icon icon-www2", searchTerms: ["www2"] },
            { title: "icon icon-yotube", searchTerms: ["yotube"] },
            { title: "icon icon-adsl", searchTerms: ["adsl"] },
            { title: "icon icon-archive", searchTerms: ["archive"] },
            { title: "icon icon-arrow-in", searchTerms: ["arrow", "in"] },
            { title: "icon icon-arrow-left", searchTerms: ["arrow", "left"] },
            { title: "icon icon-arrow-out", searchTerms: ["arrow", "out"] },
            { title: "icon icon-arrow-right", searchTerms: ["arrow", "right"] },
            { title: "icon icon-builds", searchTerms: ["builds"] },
            { title: "icon icon-cdma-icon", searchTerms: ["cdma"] },
            { title: "icon icon-check", searchTerms: ["check"] },
            { title: "icon icon-speed", searchTerms: ["speed"] },
            { title: "icon icon-double-arrow", searchTerms: ["double", "arrow"] },
            { title: "icon icon-opened", searchTerms: ["opened"] },
            { title: "icon icon-closed", searchTerms: ["closed"] },
            { title: "icon icon-extended", searchTerms: ["extended"] },
            { title: "icon icon-markerPin", searchTerms: ["markerPin"] },
            { title: "icon icon-path", searchTerms: ["path"] },
            { title: "icon icon-bus", searchTerms: ["bus"] },
            { title: "icon icon-link", searchTerms: ["link"] },
            { title: "icon icon-tv-icon", searchTerms: ["tv"] },
            // { title: "icon icon-fttx", searchTerms: ["fttx"] },
            // { title: "icon icon-vdsl", searchTerms: ["vdsl"] },
            // { title: "icon icon-fttxvdsl", searchTerms: ["fttxvdsl"] },
            { title: "icon icon-android", searchTerms: ["android"] },
            { title: "icon icon-apple", searchTerms: ["apple"] },
            { title: "icon icon-instagram", searchTerms: ["instagram"] },
            { title: "icon icon-cinema", searchTerms: ["cinema"] },
            { title: "icon icon-computer", searchTerms: ["computer"] },
            { title: "icon icon-phone", searchTerms: ["phone"] },
            // { title: "icon icon-tv]", searchTerms: ["tv"] },
        ]
    });
});